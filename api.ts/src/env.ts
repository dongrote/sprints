...
export = {
  ...
  refreshTokenExpiresInSeconds: (): number => Number(_.get(process.env, 'REFRESH_TOKEN_EXPIRES_IN_SECONDS', 3600)),
  accessTokenExpiresInSeconds: (): number => Number(_.get(process.env, 'ACCESS_TOKEN_EXPIRES_IN_SECONDS', 180)),
};
